...
ActiveRecord::Schema.define(version: 20180624210353) do
  ...
  create_table "product_groups", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
  ...
  create_table "pull_inventories", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "raked_categories", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
  ...
  create_table "skynet_id_types", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
  end

  create_table "skynet_statuses", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
    t.index ["name"], name: "index_skynet_statuses_on_name", unique: true, using: :btree
  end

  create_table "skynets", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string   "task_id"
    t.string   "inputfileurl"
    t.string   "inputfilename"
  ...
  create_table "vendor_categories", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name", null: false
    t.index ["name"], name: "index_vendor_categories_on_name", unique: true, using: :btree
  end

  create_table "vendorasins", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string   "asin"
    t.integer  "brand_id"
  ...
  create_table "vendoritems", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.decimal  "cost",                        precision: 64, scale: 2, default: "0.0"
  ...
  create_table "vendors", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string  "name"
    t.string  "addressline1"
    t.string  "addressline2"
    t.string  "city"
